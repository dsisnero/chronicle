...
module Chronicle
  module CLI
    @[Clip::Doc("Event-sourced Sans-IO agent runtime.\n" \
                ...
                "  chronicle-cli chat\n" \
                "  chronicle-cli route preview -c examples/routing_config.yml \\\n" \
    ...
    def self.exec(args : Array(String), io : IO) : Nil
      ...
      case args.first?
      when "route"
        io.puts Chronicle::CLI::Route.help rescue io.puts Root.help
      when "log"
        io.puts Chronicle::CLI::Log.help rescue io.puts Root.help
      when "session"
        io.puts Chronicle::CLI::Session.help rescue io.puts Root.help
      when "diff"
        io.puts Chronicle::CLI::DiffCmd.help rescue io.puts Root.help
      when "replay"
        io.puts Chronicle::CLI::ReplayCmd.help rescue io.puts Root.help
      when "trace"
        io.puts Chronicle::CLI::TraceCmd.help rescue io.puts Root.help
      when "fork"
    ...
    rescue ex : Chronicle::InvalidLogEncodingError
