...
describe Clarity::SQLiteEventStore do
  it "is initially empty" do
    with_db do |path|
      store = Clarity::SQLiteEventStore.new(path, "run_001")
  ...
  it "persists to disk and reloads" do
    ...
    store2 = Clarity::SQLiteEventStore.new(path, "run_001")
  ...
  it "separates runs" do
    with_db do |path|
      store = Clarity::SQLiteEventStore.new(path, "run_a")
      store.append(make_event(1_u64, "evt_001"))
      store.close

      store_b = Clarity::SQLiteEventStore.new(path, "run_b")
