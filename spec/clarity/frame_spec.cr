...
describe Clarity::Frame do
  ...
  it "FrameStack push and pop" do
    stack = Clarity::FrameStack.new
    stack.size.should eq(0)

    f1 = Clarity::Frame.new(goal: "first")
    f2 = Clarity::Frame.new(goal: "second")
