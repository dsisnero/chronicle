...
# customize the AgentRunner. This verifies Clarity's recording hook fires on
...
describe Clarity::AgentHook do
  ...
  it "returns cont actions so the runner continues" do
    hook = Clarity::AgentHook.new(nil)
