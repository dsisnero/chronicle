...
module GraphQuerySpecHelper
  ...
  def three_node_graph : Clarity::GraphProjection
    seq = 1_u64
    ...
    [a, b, c, ab, ac, bc, ba].reduce(Clarity::GraphProjection.empty) { |g, e| g.apply(e) }
  end
  ...
  def data_field(obj : Clarity::GraphObject, key : String) : String
