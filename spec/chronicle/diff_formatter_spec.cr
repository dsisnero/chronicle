...
describe Chronicle::DiffFormatter do
  it "formats an empty diff as no changes" do
    diff = Chronicle::GraphDiff.new([] of String, [] of String, [] of String, [] of String)
    output = Chronicle::DiffFormatter.format(diff)
    output.should contain("no changes")
  end

  it "lists added objects" do
    diff = Chronicle::GraphDiff.new(
      ["obj_001", "obj_002"],
      [] of String,
      [] of String,
      [] of String,
