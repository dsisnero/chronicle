...
describe Chronicle::GraphProjection do
  it "folds typed objects and relations from an ordered event log" do
    ...
    projection = Chronicle::GraphProjection.replay([object, relation])
  ...
  it "reports structural changes between projections" do
    ...
    before = Chronicle::GraphProjection.replay([first])
    after = Chronicle::GraphProjection.replay([first, second])
