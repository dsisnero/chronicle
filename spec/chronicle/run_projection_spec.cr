...
module RunProjectionSpecHelper
  ...
  def event(sequence : UInt64, payload : String) : Chronicle::Event
    Chronicle::Event.new(
...
describe Chronicle::RunProjection do
